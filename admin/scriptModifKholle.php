...
/* Les données pour l'update (format Khôlle), on a besoin de la date, la classe, du nombre d'étudiants et de la durée par étudiant, également ici du modifiable */
...
$txt_req = "UPDATE hse_declarations SET classe_id = :classeID, duree = :duree, declaration_date = :declarationDate, nbetudiants = :nbetu, dureeparetudiant = :dureeparetu, precisionsAdmin = :precisionsAdmin WHERE enseignant_id = :ensID AND declaration_id = :decID;";
